...
<p>If the police provide insufficient disclosure, your solicitor can make representations to the custody sergeant under Code C. Where disclosure is inadequate, your solicitor may advise you to make no comment in interview until proper disclosure is provided. This protects your position while ensuring fairness in the investigation.</p>`,
    faq: [
      { q: 'Can the police refuse to give disclosure?', a: 'The police must provide sufficient information under Code C, paragraph 11.1A. If they refuse, your solicitor can advise you on the implications and whether to answer questions without full disclosure.' },
      { q: 'What if I answered questions without a solicitor?', a: 'Any answers given may still be used as evidence. However, the court will consider whether you were properly advised of your rights under section 58 of PACE when assessing the weight of that evidence.' },
      { q: 'Is disclosure the same at police station and court?', a: 'No. Police station disclosure is more limited. Full prosecution disclosure occurs after charging under the Criminal Procedure and Investigations Act 1996.' }
    ],
    references: [
...
<p>After a voluntary interview, the police may release you under investigation (RUI), meaning the investigation continues without bail conditions. Alternatively, they may take no further action, charge you with an offence, or require you to return for further questioning.</p>`,
    faq: [
      { q: 'Can I refuse to attend a voluntary interview?', a: 'Yes, you can refuse. However, the police may then arrest you under section 24 of PACE if they have reasonable grounds to suspect you of an offence. It is usually better to attend with legal representation.' },
      { q: 'Do I have to answer questions in a voluntary interview?', a: 'No. You have the right to remain silent. However, under section 34 of the Criminal Justice and Public Order Act 1994, adverse inferences may be drawn if you fail to mention facts you later rely on in court.' },
      { q: 'Is a voluntary interview recorded?', a: 'Yes. Under Code E, paragraph 3.1, all interviews about indictable offences must be audio-recorded. This protects both you and the police by providing an accurate record.' }
    ],
    references: [
...
<p>A duty solicitor will: review your custody record, obtain disclosure from the investigating officer, advise you on your rights and the strength of the evidence, attend your interview and intervene if questioning becomes improper, make representations about bail or release, and ensure police procedures are followed correctly throughout.</p>`,
    faq: [
      { q: 'Is the duty solicitor service really free?', a: 'Yes, completely free. Under Schedule 1, Part 1 of the Legal Aid, Sentencing and Punishment of Offenders Act 2012, police station legal advice is not means-tested. Everyone is entitled regardless of income.' },
      { q: 'Can I choose my own solicitor instead of the duty solicitor?', a: 'Yes. Under section 58 of PACE, you can request your own solicitor. If they are unavailable, you can use the duty solicitor or wait for your chosen solicitor.' },
      { q: 'What if the police say I do not need a solicitor?', a: 'The police must inform you of your right to free legal advice under Code C, paragraph 6.1. Never waive this right. Always request a solicitor regardless of what the police say.' }
    ],
    references: [
      'Police and Criminal Evidence Act 1984, section 58',
...
<p>If you believe bail conditions are unreasonable or unnecessary, your solicitor can apply to have them varied or removed. This can be done by representations to the custody sergeant initially, or by application to the magistrates' court.</p>`,
    faq: [
      { q: 'How long can I be on police bail?', a: 'Pre-charge bail is initially limited to 28 days under section 47ZA of PACE. Extensions require senior officer approval (up to 3 months) or court approval (beyond 3 months).' },
      { q: 'What happens if I breach my bail conditions?', a: 'You can be arrested and detained. Breach without reasonable excuse is an offence under section 6 of the Bail Act 1976. You may face additional charges and find it harder to get bail again.' },
      { q: 'Can I travel abroad while on bail?', a: 'Usually not if your passport has been surrendered as a condition. If you need to travel, your solicitor can apply to vary the conditions, but this requires good reason and court approval.' }
    ],
    references: [
...
<p>Under section 41 of PACE, you can only be detained for 24 hours without charge for most offences. For serious arrestable offences, this can be extended to 36 hours with superintendent authority under section 42, and up to 96 hours with magistrates' court authority under sections 43 and 44.</p>`,
    faq: [
      { q: 'Can the police arrest me without a warrant?', a: 'Yes, under section 24 of PACE if they have reasonable grounds to suspect you of an offence and the arrest is necessary for specified reasons such as preventing harm or enabling investigation.' },
      { q: 'How long can the police hold me?', a: 'Usually up to 24 hours under section 41 of PACE. This can be extended to 36 hours by a superintendent, or up to 96 hours with court approval for serious offences.' },
      { q: 'What if the police do not tell me why I am being arrested?', a: 'Under section 28 of PACE, you must be informed of the grounds for arrest at the time, or as soon as practicable afterwards. Failure to do so may make the arrest unlawful.' }
    ],
    references: [
...
<p>If the police damage your property during a search or seizure, you may be entitled to compensation under section 22(4) of PACE. Claims should be made to the relevant police force's legal department.</p>`,
    faq: [
      { q: 'How long can the police keep my property?', a: 'Under section 22 of PACE, only as long as necessary for investigation or court proceedings. Once no longer needed, it should be returned to the owner.' },
      { q: 'What if the police refuse to return my property?', a: 'You can apply to the magistrates\' court under the Police (Property) Act 1897 for an order directing its return. You may need to prove ownership.' },
      { q: 'Can I claim compensation for damaged property?', a: 'Yes, under section 22(4) of PACE. Make a formal complaint and claim to the police force\'s legal department with evidence of the damage.' }
    ],
    references: [
...
<p>Instead of answering questions, your solicitor may advise you to read a prepared statement setting out your account. This can protect you from adverse inferences while ensuring you do not say anything that could be misinterpreted. The statement becomes part of the interview record.</p>`,
    faq: [
      { q: 'Do I have to answer police questions?', a: 'No. You have the right to remain silent. However, under the Criminal Justice and Public Order Act 1994, adverse inferences may be drawn if you fail to mention facts you later rely on in court.' },
      { q: 'What are adverse inferences?', a: 'Adverse inferences mean the court may draw conclusions from your silence. Under section 34 of the CJPOA 1994, if you failed to mention something in interview that you later rely on in court, the jury may hold this against you.' },
      { q: 'Should I give a no comment interview?', a: 'This depends on the circumstances. Always take legal advice before deciding. Your solicitor will consider the disclosure, evidence strength, and your ability to give a reliable account.' }
    ],
    references: [
...
<p>Under Code C, you must be treated with dignity. You are entitled to adequate food and drink, medical treatment if required, appropriate rest periods, and access to toilet facilities. The custody sergeant is responsible for ensuring your welfare.</p>`,
    faq: [
      { q: 'Can the police delay my right to a solicitor?', a: 'Only for serious arrestable offences and with superintendent authority under Annex B of Code C. Delay is limited to 36 hours maximum and only where specific conditions are met.' },
      { q: 'What if the police ignore my rights?', a: 'Any evidence obtained in breach of your rights may be excluded under section 78 of PACE. Make a note of what happened and inform your solicitor immediately.' },
      { q: 'Do I have to give my fingerprints and DNA?', a: 'The police can take fingerprints and DNA samples without consent under sections 61 and 63 of PACE for recordable offences. Refusal may be used against you.' }
    ],
    references: [
      'Police and Criminal Evidence Act 1984, section 56',
      'Police and Criminal Evidence Act 1984, section 58',
...
<p>After the interview, the police will decide whether to charge you, release you under investigation, release you on bail, or take no further action. Your solicitor can make representations about this decision and advise you on next steps.</p>`,
    faq: [
      { q: 'Can my solicitor speak during the interview?', a: 'Yes. Under Code C, paragraph 6.8, your solicitor may intervene to seek clarification, challenge improper questioning, or advise you. They cannot answer questions for you.' },
      { q: 'What if I want to change my answer?', a: 'You can clarify or correct answers during the interview. The recording will capture any changes. If you remember something important later, inform your solicitor who can arrange for you to provide an additional statement.' },
      { q: 'How long can an interview last?', a: 'There is no fixed time limit, but under Code C, paragraph 12.8, you must have breaks at recognised meal times and adequate rest periods. Your solicitor can request breaks if needed.' }
    ],
    references: [
...
<p>You can request your own solicitor by name, or use the duty solicitor provided by the scheme. Either way, the service is free. If your solicitor is unavailable, you can wait for them, use a duty solicitor, or request another named solicitor.</p>`,
    faq: [
      { q: 'Do I have to pay for a solicitor at the police station?', a: 'No. Police station legal advice is completely free under Legal Aid. There is no means test and no contribution required, regardless of your income or savings.' },
      { q: 'What if I am not arrested but just invited for interview?', a: 'Free legal advice is still available for voluntary interviews. Request a solicitor before attending the police station. They can obtain disclosure and attend with you.' },
      { q: 'Can I claim legal aid if I am wealthy?', a: 'Yes. Police station advice is not means-tested. Everyone is entitled to free legal representation at the police station, regardless of their financial circumstances.' }
    ],
    references: [
      'Legal Aid, Sentencing and Punishment of Offenders Act 2012, Schedule 1, Part 1',
      'Police and Criminal Evidence Act 1984, section 58',
...
function detectTopic(post) {
  ...
  if (title.includes('voluntary') || content.includes('voluntary interview')) return 'voluntary-interview';
  if (title.includes('duty solicitor') || content.includes('duty solicitor')) return 'duty-solicitor';
  ...
  if (title.includes('legal aid') || content.includes('legal aid') || content.includes('free legal')) return 'legal-aid';
...
function getRelatedPosts(currentPost, allPosts) {
  ...
  const related = allPosts
    ...
    .filter(p => detectTopic(p) === currentTopic || 
...
${relatedPosts.map(p => `  <li><a href="/blog/${p.slug}">${p.title}</a></li>`).join('\n')}
  ...
  const faqHtml = expansion.faq ? `<h2>Frequently Asked Questions</h2>
<div class="faq-section">
${expansion.faq.map(f => `<div class="faq-item">
<h4>${f.q}</h4>
<p>${f.a}</p>
</div>`).join('\n')}
</div>` : '';
...
${expansion.references.map(r => `  <li>${r}</li>`).join('\n')}
  ...
  const images = existingContent.match(/<figure class="blog-image">[\s\S]*?<\/figure>/gi) || 
  ...
  const titlePattern = new RegExp(`<h2>${post.title.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}</h2>`, 'gi');
...
${referencesHtml}
  ...
  if (metaDescription.length < 150 || metaDescription.length > 160) {
    const topicDesc = {
      'disclosure': 'Learn about police station disclosure and your right to know the case against you. Expert legal advice on PACE Code C requirements. Free solicitor representation.',
      'voluntary-interview': 'Understand your rights in voluntary police interviews. Free legal advice available. Learn when to answer questions and when to remain silent under PACE.',
      'duty-solicitor': 'What is a duty solicitor? Free legal representation at police stations and courts. Accredited solicitors available 24/7 across Kent under Legal Aid.',
      ...
      'arrest': 'Know your rights when arrested. Free legal advice under PACE section 58. Understanding detention time limits and police powers of arrest.',
      'property': 'How to get your property back from the police. Understanding seizure powers under PACE section 19 and your rights to compensation for damage.',
      'caution': 'Understanding the police caution and your right to silence. When to give no comment interviews. Expert legal advice on adverse inferences.',
      'rights': 'Your fundamental rights in police custody. Free legal advice, right to silence, and fair treatment. Accredited duty solicitors available 24/7.',
      'interview': 'What happens in a police interview? Your rights to legal representation and silence. How to prepare with your solicitor for police questioning.',
      'legal-aid': 'Free legal advice at police stations under Legal Aid. No means test required. Expert representation for arrests and voluntary interviews.'
    };
...
enhancedPosts.forEach(post => {
  ...
  if (chars >= 2800 && images === 1 && hasRefs && hasFaq && hasDisclaimer && hasRelated && hasTakeaways) {
    stats.perfect++;
  }
});
