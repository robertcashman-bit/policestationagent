...
export const metadata: Metadata = {
  title: "${area} Police Station Solicitor | ${postcode} | FREE Legal Aid | Call 07535 494446",
  description: "${action} in ${area}? Police station solicitor ${responseTime} minutes away. FREE legal aid representation. available under Legal Aid - call now.",
  alternates: {
    canonical: \`https://\${SITE_DOMAIN}/${location}\`,
  },
  openGraph: {
    title: "${area} Police Station Solicitor | ${postcode} | FREE Legal Aid | Call 07535 494446",
    description: "${action} in ${area}? Police station solicitor ${responseTime} minutes away. FREE legal aid representation. available under Legal Aid.",
