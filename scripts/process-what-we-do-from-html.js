...
async function findFile() {
  ...
  const searchPaths = [
    path.join(
      DOWNLOADS_DIR,
      "Christmas & Bank Holiday Opening Hours ｜ Police Station Agent (11_12_2025 16：35：30).html"
    ),
...
async function main() {
  ...
  if (!filePath) {
    ...
    console.log(
      '  node scripts/process-what-we-do-from-html.js "C:\\Users\\rober\\Downloads\\Christmas & Bank Holiday Opening Hours ｜ Police Station Agent (11_12_2025 16：35：30).html"'
    );
