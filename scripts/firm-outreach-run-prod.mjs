 ...
 *
 * Usage:
 *   bash -c 'set -a; source .env.vercel.production; set +a; npx tsx scripts/firm-outreach-run-prod.mjs enrich --limit=50'
 *   bash -c 'set -a; source .env.vercel.production; set +a; npx tsx scripts/firm-outreach-run-prod.mjs send --apply --limit=50'
 */
