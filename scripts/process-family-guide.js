/**
 * Process "What To Do If a Loved One Is Arrested" HTML file
 */
...
function extractMetadata(html) {
  ...
  return {
    title:
      ...
      "What To Do If a Loved One Is Arrested in Kent | Family Guide",
...
async function main() {
  ...
  const targetFile = files.find(
    (f) => f.includes("What To Do If a Loved One Is Arrested") && f.endsWith(".html")
  );

  if (!targetFile) {
    console.error(
      '❌ Could not find "What To Do If a Loved One Is Arrested" HTML file in Downloads'
    );
    process.exit(1);
  }
