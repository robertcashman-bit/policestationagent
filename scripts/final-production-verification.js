...
async function verify() {
  ...
  try {
    ...
    const hasPrivacyPolicy =
      (html.includes("Privacy Policy") || html.includes("Privacy&nbsp;Policy")) &&
      (html.includes('href="/privacy"') ||
        html.includes("href='/privacy'") ||
        html.includes("/privacy"));
    const hasCookiesPolicy =
      (html.includes("Cookies Policy") || html.includes("Cookies&nbsp;Policy")) &&
      (html.includes('href="/cookies"') ||
        html.includes("href='/cookies'") ||
        html.includes("/cookies"));
    const hasAccessibility =
      html.includes("Accessibility") &&
      (html.includes('href="/accessibility"') ||
        html.includes("href='/accessibility'") ||
        html.includes("/accessibility"));
    const hasGDPR =
      html.includes("GDPR") &&
    ...
    const termsNearInfo =
      infoIdx > 0 && termsLinkIdx > 0 && Math.abs(termsLinkIdx - infoIdx) < 2000;
    ...
    const hasRightsLinksInDropdown =
      infoSection.includes("Your Rights in Custody") ||
    ...
    console.log(
      "   ✗ FAQ in dropdown:",
      hasFAQInDropdown ? "FOUND (SHOULD NOT BE)" : "NOT FOUND (CORRECT)"
    );
    console.log(
      "   ✗ Rights links in dropdown:",
      hasRightsLinksInDropdown ? "FOUND (SHOULD NOT BE)" : "NOT FOUND (CORRECT)"
    );
