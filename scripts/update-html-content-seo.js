...
function updateHTMLContent(filePath) {
  ...
  content = content.replace(
    /24\/7 Police Station Agent in Kent/g,
  ...
  content = content.replace(
    /24\/7, including weekends/g,
    "Extended hours including evenings, weekends"
  );
  content = content.replace(
    /Available 24\/7 across all Kent custody suites/g,
    "Extended hours service across all Kent custody suites"
  );
  content = content.replace(/available 24\/7/g, "available for extended hours");
  content = content.replace(
    /FREE legal advice available 24\/7/g,
  ...
  content = content.replace(
    /Need a Police Station Agent in Kent\?/g,
    "Need a Police Station Duty Solicitor in Kent?"
  );
  ...
  // Update H1 headings
  content = content.replace(
    /<h1[^>]*>24\/7 Police Station Agent in Kent<\/h1>/g,
    '<h1 id="kent-hero" class="text-4xl md:text-6xl font-black mb-6">Police Station Duty Solicitor Kent</h1>'
  );

  // Update FAQ content
  content = content.replace(
    /How quickly can a police station agent attend/g,
    "How quickly can a duty solicitor attend"
  );
  content = content.replace(
    /What is the difference between a duty solicitor and a police station agent\?/g,
  ...
  content = content.replace(
    /extended hours representation - 9am till late/g,
    "Extended hours service"
  );
  content = content.replace(
    /extended hours extended hours representation - 9am till late/g,
    "Extended hours service"
  );

  // Update "24/7" in FAQ answers
  content = content.replace(
    /Our extended hours service operates 24\/7, including weekends/g,
    "Our extended hours service covers evenings, weekends"
  );
