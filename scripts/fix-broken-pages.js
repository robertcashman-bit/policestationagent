...
async function checkAndFixEmptyFiles() {
  ...
  for (const file of emptyFiles) {
    try {
      ...
      if (stats.size === 0) {
        console.log(`⚠️  Found empty file: ${file.name}`);
        // These should be fine - blog and services already have correct implementations
        // Admin edit page can be created if needed
      }
    } catch (e) {
