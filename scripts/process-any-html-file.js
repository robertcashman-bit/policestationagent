...
async function main() {
  ...
  if (!filePath || !route) {
    ...
    console.log("\nExamples:");
    console.log(
      '  node scripts/process-any-html-file.js "C:\\Users\\rober\\Downloads\\After Interview.html" "/after-a-police-interview"'
    );
    console.log(
      '  node scripts/process-any-html-file.js "Downloads\\Terms.html" "/terms-and-conditions"'
    );
