              ...
              <div className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 mb-4">When arrested or invited for interview, tell the custody officer: <strong>"I want Robert Cashman"</strong> or <strong>"I want Tuckers Solicitors LLP - Robert Cashman"</strong>. They must contact us. You can also call us directly on <strong>03330497036</strong> or <strong>020 8242 1857</strong>.</p>
                    <div className="flex flex-col sm:flex-row gap-3">
                      <a href="tel:03330497036" className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 shadow h-9 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white flex items-center gap-2">
