...
function extractMetadata(html) {
  ...
  return {
    title:
      ...
      "Urgent Police Station Help | Has Someone Been Arrested? | 24/7 Free Advice",
    description:
      document.querySelector('meta[name="description"]')?.getAttribute("content") ||
      "Emergency Help: Has a friend or family member been arrested in Kent? You can instruct a solicitor on their behalf. Call 0333 049 7036 immediately for We aim to respond as quickly as possible. If detained, ask custody staff to contact a solicitor..",
    canonical:
      document.querySelector('link[rel="canonical"]')?.getAttribute("href") ||
      "https://policestationagent.com/arrestednow",
  };
}
...
async function main() {
  ...
  const targetFile = files.find(
    (f) => f.includes("Urgent Police Station Help") && f.includes("Arrested") && f.endsWith(".html")
  );
