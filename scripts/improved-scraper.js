...
const PAGES_TO_SCRAPE = [
  ...
  {
    route: "/importance-of-early-legal-advice",
    file: "app/importance-of-early-legal-advice/page.tsx",
  },
  ...
  { route: "/booking-in-procedure-in-kent", file: "app/booking-in-procedure-in-kent/page.tsx" },
  {
    ...
    file: "app/what-to-do-if-a-loved-one-is-arrested/page.tsx",
  },
];
      ...
      try {
        ...
        data = await page.evaluate(() => {
          ...
          if (main) {
            ...
            clone
              .querySelectorAll(
                'script, style, noscript, nav, header, footer, .header, .footer, .nav, .cookie-banner, [class*="cookie"], [id*="cookie"], [class*="sidebar"], [class*="widget"], [class*="menu"]'
              )
        ...
        if (data && data.hasContent) {
          ...
          console.log(
            `    ⚠️  Content check: is404=${data?.is404}, hasContent=${data?.hasContent}, htmlLength=${data?.htmlLength}`
          );
        }
      } catch (error) {
