 ...
 * widgets, gov.uk, placeholders) or whose websiteUrl points at our own sites.
 * Clears email and moves back to discovered so enrichment can find the firm's real address.
 */
