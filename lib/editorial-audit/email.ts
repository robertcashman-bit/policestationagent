...
/** Findings-only digest. No all-clear mail. suggested_fix is metadata only. */
  ...
  const html = `
    <div style="font-family:system-ui,sans-serif;color:#0f172a;max-width:640px;">
      ...
      <p style="margin:0 0 16px;line-height:1.5;">
        ...
        Suggested fixes below are for manual review — nothing was auto-edited.
      </p>
      ${formatFindingRows(opts.findings)}
      ${opts.extraHtml ?? ''}
      <p style="color:#64748b;font-size:12px;line-height:1.5;margin-top:24px;">
        Date: ${escapeHtml(opts.date)} · Site: ${escapeHtml(SITE_URL)} ·
        Run <code>npx tsx scripts/run-editorial-audit.ts</code> for a manual pass.
      </p>
    </div>
  `;
