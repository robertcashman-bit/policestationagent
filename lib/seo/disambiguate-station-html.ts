...
const INTRO_HTML = `<aside class="rounded-lg border border-red-200 bg-red-50 p-4 md:p-5 mb-6 max-w-4xl mx-auto" ${INTRO_MARKER} aria-label="Not the police"><p class="text-sm md:text-base text-slate-800 leading-relaxed mb-2"><strong class="text-red-900">NOT THE POLICE.</strong> We are <strong>criminal solicitors</strong> serving this station — not a police contact directory, custody suite phone book, or station switchboard.</p><p class="text-sm text-slate-700 mb-2">${STATION_SOLICITOR_CTA}</p><p class="text-sm text-slate-700 mb-3">Police assistance: <strong>999</strong> or <strong>101</strong>. We do not publish custody suite telephone numbers.</p><p class="flex flex-wrap gap-2"><a href="/start/voluntary-interview#request" class="inline-flex items-center justify-center min-h-[48px] rounded-md bg-blue-800 px-4 py-2 text-sm font-bold text-white hover:bg-blue-900">Request representation</a><a href="/current-custody" class="inline-flex items-center justify-center min-h-[48px] rounded-md bg-red-700 px-4 py-2 text-sm font-bold text-white hover:bg-red-800">Check custody now</a><a href="/contact" class="inline-flex items-center justify-center min-h-[48px] rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-800 hover:bg-slate-50">${STATION_CONTACT_BUTTON}</a></p></aside>`;
