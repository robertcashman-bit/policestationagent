        ...
        <div className="bg-slate-50 min-h-screen">
          <div className="prose prose-lg max-w-6xl mx-auto px-4 py-16">
            ...
            <p className="lead text-xl text-slate-700 mb-8">
              Bail decisions and bail conditions can have an immediate impact on your life—where you can go, who you can
              contact, and what you must do next. We provide clear advice and practical representation to protect your
              position and challenge unreasonable restrictions where appropriate.
            </p>

            <h2>Common bail situations</h2>
            <ul>
              <li>
                <strong>Police bail:</strong> release from the police station with conditions and a return date.
              </li>
              <li>
                <strong>Court bail:</strong> release pending court proceedings, sometimes with stricter conditions.
              </li>
              <li>
                <strong>Variations:</strong> applications to change or remove conditions (for example, contact or address
                restrictions).
              </li>
              <li>
                <strong>RUI (Released Under Investigation):</strong> no bail conditions, but the investigation continues.
              </li>
            </ul>

            <h2>How we approach bail</h2>
            <p>
              The right strategy depends on the facts of the case and the evidence. We focus on practical, persuasive
              proposals—addressing risk factors, proposing workable conditions, and ensuring you understand the
              consequences of breach.
            </p>

            <div className="not-prose mt-10 rounded-xl border bg-white shadow p-6">
              <h3 className="text-xl font-bold text-slate-900 mb-2">Need advice about bail or conditions?</h3>
              <p className="text-slate-700 mb-4">
                If you have been bailed, given a return date, or you are unsure what you can and cannot do, call us for
                urgent guidance.
              </p>
              ...
              <p className="text-xs text-slate-500 mt-4">
                If you are at a police station, ask for a solicitor. Police station advice is free under Legal Aid.
              </p>
            </div>
          </div>
        </div>
