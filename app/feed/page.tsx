...
export const metadata: Metadata = {
  ...
  description:
    "Subscribe to RSS feeds for Police Station Agent blog posts. Get updates on criminal defence advice, legal rights, and police station representation.",
  robots: {
    index: true,
    follow: true,
  },
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                Stay updated with the latest criminal defence advice, legal rights information, and
                police station representation guidance.
              </p>
            </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center flex-shrink-0">
                    <svg
                      ...
                      className="lucide lucide-rss w-6 h-6 text-white"
                    >
            ...
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {categoryOrder.map((category) => {
                  const slug =
                    categorySlugs[category] || category.toLowerCase().replace(/\s+/g, "-");
                  return (
                    <div
                      key={category}
              ...
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start gap-2">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-check-circle text-green-600 flex-shrink-0 mt-0.5"
                  >
                    <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                    <polyline points="22 4 12 14.01 9 11.01"></polyline>
                  </svg>
                  <span>
                    Copy the feed URL and paste it into your RSS reader (Feedly, NewsBlur, etc.)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <svg
                  ...
                  <span>
                    Subscribe to specific categories to get only the topics you're interested in
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <svg
                  ...
                  <span>
                    Feeds update automatically - you'll be notified when new posts are published
                  </span>
                </li>
              </ul>
            </div>
