        ...
        <div className="bg-slate-50 min-h-screen">
          <div className="prose prose-lg max-w-6xl mx-auto px-4 py-16">
            ...
            <p className="lead text-xl text-slate-700 mb-8">
              Finding out that a loved one has been arrested can be distressing. This guide explains
              what you can do to help and how to ensure they get the best legal representation.
            </p>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                While it's natural to be worried, staying calm will help you take the right steps to
                help your loved one.
              </p>

              <h3 className="text-2xl font-semibold mb-3 mt-6">2. Find Out Which Police Station</h3>
              <p className="mb-4">
                Ask the police which station your loved one has been taken to. Your loved one has a
                right to have someone informed of their arrest (PACE s.56).
                <Ref n={1} />
              </p>
              ...
              <ul className="list-disc pl-6 mb-4 space-y-2">
                <li>
                  Legal advice at the police station is free in many situations (see GOV.UK
                  overview)
                  <Ref n={3} />
                </li>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                While in custody, your loved one has important rights including legal advice (PACE
                s.58) and having someone informed (PACE s.56).
                <Ref n={2} /> <Ref n={1} />
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal pl-6 mb-4 space-y-2">
                <li>
                  <strong>Booking in:</strong> Your loved one will be processed at the police
                  station
                </li>
                <li>
                  <strong>Legal advice:</strong> A solicitor will attend to provide representation
                </li>
                <li>
                  <strong>Interview:</strong> They may be interviewed (with their solicitor present)
                </li>
                <li>
                  <strong>Decision:</strong> The police will decide whether to charge, release under
                  investigation, or take no further action
                </li>
              </ol>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                If your loved one is vulnerable (e.g. mental health issues, learning disabilities),
                inform the solicitor immediately. PACE Code C contains safeguards for vulnerable
                detainees, including appropriate adult safeguards.
                <Ref n={4} />
              </p>
            </section>
            ...
            <section className="mb-8 bg-red-50 p-6 rounded-lg border border-red-200">
              ...
              <p className="mb-4">
                Time is important. The sooner a solicitor is instructed, the better. Your loved one
                should not be interviewed without legal representation unless they specifically
                waive this right.
              </p>
            </section>
            ...
            <section className="mb-8 bg-blue-50 p-6 rounded-lg border border-blue-200">
              ...
              <p className="mb-4">
                If a loved one has been arrested, call us immediately. We provide free extended
                hours legal advice and representation at all Kent police stations. You can instruct
                us on their behalf.
              </p>
              <p className="mb-4">
                <strong>
