  ...
  const sources: LegalSource[] = [
    {
      id: "pace-s40",
      label:
        "Police and Criminal Evidence Act 1984 (PACE) s.40 (reviews of detention; 6-hour / 9-hour review timetable)",
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded-r-lg">
            <p className="text-lg font-medium text-slate-800">
              <strong>Quick Answer:</strong> Police can hold you for up to <strong>24 hours</strong>{" "}
              without charge. For serious offences, this can be extended to{" "}
              <strong>36 hours</strong> by a senior officer, or up to <strong>96 hours</strong> with
              a magistrate's authorisation. These limits are set by the Police and Criminal Evidence
              Act 1984 (PACE).
              <Ref n={2} /> <Ref n={3} /> <Ref n={5} />
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              When you're arrested and taken to a police station, the clock starts ticking. The
              Police and Criminal Evidence Act 1984 (PACE) sets strict time limits on how long
              police can detain you before they must either charge you or release you.
            </p>
            <p>
              Note: some situations can involve different detention rules under other legislation.
              This page focuses on the PACE detention framework.
              <Ref n={2} />
            </p>

            <h2>The 24-Hour Rule</h2>
            <p>
              Under PACE, a person generally must not be kept in police detention for more than 24
              hours without being charged (subject to PACE sections 42 and 43).
              <Ref n={2} /> The 24-hour period is calculated from “relevant time” as defined in PACE
              section 41(2).
              <Ref n={2} />
            </p>
            <ul>
            ...
            <p>
              In many cases “relevant time” is linked to arrival at a police station, but PACE
              section 41(2) sets out multiple scenarios and (in some cases) uses the earlier of
              arrival time and “24 hours after arrest”.
              <Ref n={2} />
            </p>

            <h2>Extensions to 36 Hours</h2>
            <p>
              A superintendent (or above) responsible for the station can authorise detention up to
              36 hours after relevant time if the statutory conditions in PACE section 42 are met
              (including necessity and that the offence is indictable).
              <Ref n={3} /> This requires:
            </p>
            <ul>
              <li>The investigation to be proceeding diligently and expeditiously</li>
              <li>
                Your detention to be necessary to secure or preserve evidence, or obtain evidence by
                questioning
              </li>
              <li>
                The offence to be an indictable offence (PACE s.42).
                <Ref n={3} />
              </li>
            </ul>
            ...
            <p>
              Police can apply to a magistrates’ court for a{" "}
              <strong>warrant of further detention</strong> under PACE section 43 (subject to
              statutory requirements).
              <Ref n={4} /> Under PACE section 44, detention under warrants (and extensions) is
              capped so that it cannot end later than 96 hours after relevant time.
              <Ref n={5} />
            </p>
            <p>These hearings are formal court proceedings. You have the right to:</p>
            <ul>
            ...
            <p>
              The Police and Criminal Evidence Act 1984 (PACE), specifically{" "}
              <strong>Sections 41-44</strong>, governs custody time limits:
            </p>
            <ul>
              <li>
                <strong>Section 41:</strong> basic 24-hour limit and “relevant time” definition
                <Ref n={2} />
              </li>
              <li>
                <strong>Section 42:</strong> superintendent authorisation up to 36 hours (in
                indictable cases, if conditions met)
                <Ref n={3} />
              </li>
              <li>
                <strong>Section 43:</strong> warrants of further detention by magistrates’ court
                <Ref n={4} />
              </li>
              <li>
                <strong>Section 44:</strong> extensions of warrants and the 96-hour cap after
                relevant time
                <Ref n={5} />
              </li>
            </ul>
            <p>
              Detention reviews are addressed in PACE section 40 (including the first 6-hour review
              and subsequent 9-hour reviews).
              <Ref n={1} />
            </p>

            <h2>Detention Reviews</h2>
            <p>
              Your detention must be regularly reviewed by a custody officer to ensure it remains
              necessary:
            </p>
            <ul>
              <li>
                <strong>First review:</strong> not later than 6 hours after detention was first
                authorised (PACE s.40(3))
                <Ref n={1} />
              </li>
              <li>
                <strong>Second review:</strong> not later than 9 hours after the first (PACE
                s.40(3))
                <Ref n={1} />
              </li>
              <li>
                <strong>Subsequent reviews:</strong> intervals of not more than 9 hours (PACE
                s.40(3))
                <Ref n={1} />
              </li>
            </ul>
            <p>
              The review officer must be satisfied that your continued detention is necessary for
              one of the statutory purposes—typically to secure, preserve or obtain evidence.
            </p>

            <h2>What to Do If You're Facing Extended Detention</h2>
            <p>If police are seeking to extend your detention beyond 24 hours:</p>
            <ol>
              <li>
                <strong>Request a solicitor immediately</strong> – Legal advice is free and
                confidential
              </li>
              <li>
                <strong>Understand the reasons</strong> – You should be told why an extension is
                being sought
              </li>
              <li>
                <strong>Your solicitor can make representations</strong> – particularly if the
                statutory conditions are not met
              </li>
              <li>
                <strong>Keep track of time</strong> – the key time limits are tied to “relevant
                time” under PACE s.41
              </li>
            </ol>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                  How long can police hold me without charge in the UK?
                </h3>
                <p className="text-slate-700">
                  Under PACE, police detention without charge is generally limited to 24 hours (from
                  “relevant time”). A superintendent can authorise detention up to 36 hours in
                  indictable cases if conditions are met, and a magistrates’ court can issue/extend
                  warrants subject to the 96-hour cap after relevant time.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  After 24 hours, the police must either charge you, release you, or apply for an
                  extension. Extensions require authorisation from a superintendent (up to 36 hours)
                  or a magistrate (up to 96 hours) and are only granted for serious offences.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                  Can police extend my detention beyond 24 hours?
                </h3>
                <p className="text-slate-700">
                  Yes. Under PACE, a superintendent can authorise detention up to 36 hours in
                  indictable cases if conditions are met. Beyond that, police must apply to a
                  magistrates’ court for a warrant of further detention; extensions are subject to
                  statutory limits, including the 96-hour maximum after relevant time.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  PACE provides that the first review must be not later than six hours after
                  detention was first authorised, the second not later than nine hours after the
                  first, and subsequent reviews at intervals of not more than nine hours.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                  What are my rights if police want to extend my detention?
                </h3>
                <p className="text-slate-700">
                  You have the right to legal representation at any extension hearing. Your
                  solicitor can make representations on your behalf. You should be told the reasons
                  for the extension and have the opportunity to challenge it.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 text-white rounded-xl p-8 my-12">
            ...
            <p className="text-slate-300 mb-6">
              If you or someone you know is being held in police custody, you have the right to free
              legal advice. I provide extended hours police station representation across all Kent
              custody suites.
            </p>
