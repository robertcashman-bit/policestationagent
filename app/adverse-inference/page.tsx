...
export const metadata: Metadata = {
  ...
  description:
    "Adverse inference means courts can treat your silence as suspicious. Learn when it applies, how to avoid it, and what Section 34 CJPOA 1994 means for your case.",
  alternates: {
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded-r-lg">
            <p className="text-lg font-medium text-slate-800">
              <strong>Quick Answer:</strong> An adverse inference is when a court or jury is
              permitted to treat your silence during police interview as evidence that supports the
              prosecution case. Under
              <strong> Section 34 of the Criminal Justice and Public Order Act 1994</strong>, if you
              fail to mention a fact you later rely on in your defence, the court or jury may draw
              inferences that appear proper (depending on the circumstances).
              <Ref n={1} />
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              ...
              on it at trial, the court may think: "If that was true, why didn't you say so at the
              time?"
            </p>
            <p>
              Whether an inference can be drawn depends on whether the fact was one you could
              reasonably have been expected to mention at the time (that “reasonableness” test is in
              section 34 itself).
              <Ref n={1} />
            </p>
            ...
            <p>
              Section 34 of the Criminal Justice and Public Order Act 1994 sets out when adverse
              inferences can be drawn. The conditions are:
            </p>
            <ol>
              ...
              <li>
                It was a fact that, in the circumstances at the time, you could reasonably have been
                expected to mention
              </li>
            </ol>
            <p>
              Section 34 also includes an important safeguard: where the accused was at an
              authorised place of detention, section 34(1)–(2) do not apply if they were not allowed
              an opportunity to consult a solicitor before being questioned/charged/informed
              (s.34(2A)).
              <Ref n={1} />
            </p>
            ...
            <ul>
              <li>
                <strong>It’s discretionary:</strong> the court/jury may draw “such inferences … as
                appear proper” in the circumstances (s.34(2)).
                <Ref n={1} />
              </li>
              <li>
                <strong>It’s conditional:</strong> section 34 only applies where its conditions are
                met (including the “reasonably have been expected to mention” test).
                <Ref n={1} />
              </li>
              <li>
                <strong>There may be good reasons for silence</strong> – Which the court should
                consider
              </li>
            </ul>

            <h2>When Adverse Inferences Are Most Dangerous</h2>
            <p>Adverse inference arguments are most commonly made where:</p>
            <ul>
              <li>
                You raise a new defence at trial that you never mentioned before (e.g., alibi,
                self-defence)
              </li>
              <li>
                The defence is specific and detailed – something you clearly would have known at the
                time
              </li>
            ...
            <p>There are several ways to avoid or minimise the risk of adverse inference:</p>

            <h3>1. Answer Questions Fully</h3>
            <p>
              If you have an innocent explanation, putting it on record during interview prevents
              adverse inference. The court can't criticise you for not mentioning something you did
              mention.
            </p>
            ...
            <p>
              ...
              allows you to put key facts on record while avoiding live questioning. If you later
              rely on facts that were never mentioned, section 34 is the mechanism by which
              inferences may be considered (depending on what was reasonable at the time).
              <Ref n={1} />
            </p>

            <h3>3. Act on Legal Advice</h3>
            <p>
              If you remain silent on your solicitor's advice, this is relevant context. Courts are
              less likely to draw adverse inferences if you followed professional legal advice,
              though this isn't absolute protection.
            </p>

            <h3>4. Document the Reasons for Silence</h3>
            <p>
              If there are good reasons for not answering (e.g., insufficient disclosure,
              unfitness), your solicitor should make a record of this at the time.
            </p>

            <h2>The Role of Legal Advice</h2>
            <p>
              Having a solicitor present is crucial when considering your interview strategy. The
            ...
            <p>
              In practice, the impact of adverse inference can vary depending on the rest of the
              evidence. For example, a court or jury may consider that:
            </p>
            <ul>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  An adverse inference is when a court or jury is allowed to treat your silence
                  during a police interview as evidence against you. If you fail to mention
                  something you later rely on at trial, they may conclude you made it up afterwards.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  No, you cannot be convicted solely on the basis of adverse inference. It is
                  supporting evidence only. The prosecution must still prove the case beyond
                  reasonable doubt with other evidence.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  Adverse inferences can be drawn under Section 34 CJPOA 1994 when: you were
                  cautioned before interview, you failed to mention a fact when questioned, you
                  later rely on that fact at trial, and it was reasonable to expect you to mention
                  it.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  To avoid adverse inference: answer questions fully if you have a defence, or
                  provide a prepared statement covering key facts. The statement should include any
                  fact you intend to rely on at trial.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  Having a solicitor helps because their advice may explain your silence. Courts are
                  less likely to draw adverse inferences if you followed legal advice. However, this
          ...
          <div className="bg-slate-900 text-white rounded-xl p-8 my-12">
            ...
            <p className="text-slate-300 mb-6">
              Understanding adverse inference is crucial before any police interview. I can advise
              on the best strategy for your case – whether that's a full interview, no comment, or a
              prepared statement.
            </p>
