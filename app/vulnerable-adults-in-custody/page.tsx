        ...
        <div className="bg-slate-50 min-h-screen">
          <div className="prose prose-lg max-w-6xl mx-auto px-4 py-16">
            ...
            <section className="mb-8 bg-blue-50 p-6 rounded-lg border border-blue-200">
              ...
              <p className="mb-4">
                <strong>Call us extended hours on <a href="tel:01732247427" className="text-blue-600 hover:text-blue-800 font-semibold">01732 247427</a></strong> for free legal advice and representation.
              </p>
            </section>
