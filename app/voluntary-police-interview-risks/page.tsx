        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-6 mb-10 rounded-r-lg">
            <p className="text-slate-900">
              ...
              <Ref n={1} /> Interview rules are governed by PACE Code C.
              <Ref n={2} /> Silence can carry risks in some circumstances under CJPOA 1994 s.34.
              <Ref n={3} />
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul>
              <li>
                <strong>Ask for a solicitor</strong> and take advice before the interview (PACE
                s.58).
                <Ref n={1} />
              </li>
              <li>
              ...
              <li>
                <strong>Do not guess</strong> or try to “clear it up” without advice—interviews are
                recorded and can be used in evidence (Code C and the interview recording codes).
                <Ref n={2} />
              </li>
            </ul>
            ...
            <ul>
              <li>
                <Link href="/what-happens-if-ignore-police-interview">
