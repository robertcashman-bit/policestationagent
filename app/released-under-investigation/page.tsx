        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded-r-lg">
            <p className="text-lg font-medium text-slate-800">
              ...
              police custody while the investigation continues. People often use “RUI” to describe being released without bail while the investigation continues. If you need advice, ask for a solicitor (PACE s.58).<Ref n={1} />
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul>
              <li>You can seek legal advice at any time (PACE s.58).<Ref n={1} /></li>
