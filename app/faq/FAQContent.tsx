    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Start with the SRA PSRAS pages and the Legal Aid Agency Police Station Register Arrangements. Career and accreditation guidance for police station representatives lives on <a href='https://www.policestationrepuk.org/' class='text-blue-600 hover:underline font-semibold' rel='noopener noreferrer' target='_blank'>Police Station Rep UK</a>. For exam and CIT preparation (not a substitute for official rules), see <a href='https://www.psrtrain.com' class='text-blue-600 hover:underline font-semibold' rel='noopener noreferrer' target='_blank'>PSR Train</a>. Criminal defence firms handle supervision and instructions; solicitors needing Kent agent cover can use <a href='/for-solicitors' class='text-blue-600 hover:underline font-semibold'>agency cover</a>.",
        },
      ],
    },
    {
