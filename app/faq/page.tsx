            ...
            <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-20">
              <div className="max-w-4xl mx-auto px-4 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border bg-white shadow-sm h-10 rounded-md px-8 border-white text-white hover:bg-white hover:text-blue-900" href="/contact">
                    Contact Us
                  </a>
                </div>
              </div>
