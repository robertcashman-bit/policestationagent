        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded-r-lg">
            <p className="text-lg font-medium text-slate-800">
              <strong>Quick Answer:</strong> An appropriate adult is a person who attends the police
              station to support a <strong>young person (under 18)</strong> or{" "}
              <strong>vulnerable adult</strong>. PACE Code C describes the appropriate adult’s role
              as safeguarding the rights, entitlements and welfare of juveniles and vulnerable
              persons.
              <Ref n={1} /> As a general rule, a detained juvenile or vulnerable person must not be
              interviewed in the absence of the appropriate adult, subject to limited exceptions set
              out in Code C.
              <Ref n={1} />
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Under PACE Code C, certain detainees are entitled to have an "appropriate adult"
              present during their time in police custody. This safeguard exists to protect
              vulnerable people who may not fully understand the procedures or their rights.
            </p>
            <p>
              The appropriate adult is there to support the detainee – not to replace a solicitor or
              to assist the police. Their role is separate from and in addition to legal
              representation.
            </p>
            ...
            <ul>
              <li>
                <strong>All persons under 18</strong> – regardless of maturity or understanding
              </li>
              <li>
                <strong>Adults who appear to have mental health conditions</strong>
              </li>
              <li>
                <strong>Adults with learning disabilities or difficulties</strong>
              </li>
              <li>
                <strong>Adults who appear unable to understand the process</strong>
              </li>
            </ul>
            <p>
            ...
            <ul>
              <li>
                <strong>Support:</strong> Providing reassurance and emotional support
              </li>
              <li>
                <strong>Communication:</strong> Helping the detainee understand what's happening
              </li>
              <li>
                <strong>Rights:</strong> Ensuring the detainee knows their rights
              </li>
              <li>
                <strong>Observation:</strong> Watching that interviews and procedures are fair
              </li>
              <li>
                <strong>Intervention:</strong> Speaking up if treatment is improper or oppressive
              </li>
              <li>
                <strong>Assistance:</strong> Helping with communication if needed
              </li>
            </ul>
            ...
            <p>The roles are different and complementary:</p>
            ...
            <p>
              A vulnerable person should have <strong>both</strong> an appropriate adult and a
              solicitor.
            </p>

            <h2>What If No Appropriate Adult Is Available?</h2>
            <p>If no suitable appropriate adult is immediately available, police must:</p>
            <ul>
            ...
            <ol>
              <li>
                <strong>Listen:</strong> Let the detainee talk and express concerns
              </li>
              <li>
                <strong>Don't advise:</strong> Leave legal advice to the solicitor
              </li>
              <li>
                <strong>Take notes:</strong> Record what happens and when
              </li>
              <li>
                <strong>Speak up:</strong> If something seems wrong, say so
              </li>
              <li>
                <strong>Stay calm:</strong> Your composure helps the detainee
              </li>
              <li>
                <strong>Ask for breaks:</strong> If the detainee is struggling
              </li>
            </ol>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  An appropriate adult supports and safeguards the rights and welfare of a juvenile
                  or vulnerable person at the police station (PACE Code C).
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  For young people: parent, guardian, social worker, or responsible adult. For
                  vulnerable adults: relative, trained volunteer, or social worker. Not police
                  officers or the detainee's solicitor.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  PACE Code C contains safeguards requiring an appropriate adult for juveniles and
                  for adults treated as vulnerable for the purposes of the Code, including rules
                  about interviews.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  They support and reassure the detainee, ensure they understand their rights,
                  observe that procedures are fair, intervene if treatment is improper, and assist
                  with communication.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  If a parent/guardian cannot attend or is not suitable, police should arrange a
                  different appropriate adult (for example, a social worker or another responsible
                  adult) in line with PACE Code C.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 text-white rounded-xl p-8 my-12">
            ...
            <p className="text-slate-300 mb-6">
              If you're acting as appropriate adult or need to support a vulnerable family member, I
