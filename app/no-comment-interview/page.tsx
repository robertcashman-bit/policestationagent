...
export const metadata: Metadata = {
  ...
  description:
    'Should you go "no comment" in a police interview? Learn when staying silent protects you, when it could harm your defence, and how adverse inferences work.',
  alternates: {
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-br from-slate-800 via-blue-900 to-slate-900 text-white py-16">
          <div className="max-w-4xl mx-auto px-4">
            <nav className="text-sm mb-6 text-blue-200">
              ...
              <Link href="/police-interview-rights" className="hover:text-white">
                Interview Rights
              </Link>
              <span className="mx-2">›</span>
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>"No comment" is a phrase used to decline to answer a question in interview.</p>
            <p>
              The decision to go "no comment" is a major tactical choice. It depends on what the
              police have disclosed, what you are being asked about, and the risks of saying
              something inaccurate or incomplete.
            </p>

            <h2>Your Right to Silence</h2>
            <p>
              One key legal risk of silence is adverse inference: section 34 CJPOA 1994 deals with
              failures to mention facts when questioned under caution (or when charged/informed)
            ...
            <ol>
              <li>
                <strong>You can stay silent</strong> – but
              </li>
              <li>
                <strong>Silence can be relevant later</strong> if you rely on facts you did not
                mention when you could reasonably have been expected to mention them.
                <Ref n={1} />
              </li>
            </ol>
            ...
            <ul>
              <li>
                <strong>Insufficient disclosure:</strong> When the police haven't told you enough
                about what you're accused of to respond meaningfully
              </li>
              <li>
                <strong>Need to gather evidence:</strong> When you need to verify facts, check
                documents, or speak to witnesses before giving your account
              </li>
              <li>
                <strong>Complex legal issues:</strong> When the case involves complicated legal
                points that require proper analysis
              </li>
              <li>
                <strong>Risk of self-incrimination:</strong> When answering questions honestly could
                incriminate you in other matters
              </li>
              <li>
                <strong>Fitness concerns:</strong> When you're unwell, under the influence, or
                otherwise unfit to be interviewed properly
              </li>
            </ul>

            <h2>When "No Comment" May Be Risky</h2>
            <p>Staying silent isn't always the best strategy. Consider these situations:</p>
            <ul>
              <li>
                <strong>Clear alibi:</strong> If you have an innocent explanation that can be
                verified, putting it on record early can be powerful
              </li>
              <li>
                <strong>Overwhelming evidence:</strong> If the evidence against you is strong,
                cooperation may help
              </li>
              <li>
                <strong>Positive defence:</strong> If you're going to rely on a specific defence at
                trial, mentioning it now protects you from adverse inferences
              </li>
            </ul>

            <h2>Understanding Adverse Inferences</h2>
            <p>
              Under the Criminal Justice and Public Order Act 1994, the court can draw{" "}
              <strong>adverse inferences</strong>
            ...
            <ul>
              ...
              <li>
                ...the court or jury may treat your silence as evidence that you made up the defence
                later
              </li>
              <li>
                This is fact-specific and depends on what was reasonable to expect at the time
                (s.34).
                <Ref n={1} />
              </li>
            </ul>
            ...
            <p>
              A{" "}
              <Link href="/prepared-statements" className="text-blue-600 hover:underline">
                prepared statement
              </Link>{" "}
              offers a middle ground between full interview and complete silence. This is a written
              statement, prepared with your solicitor, which sets out your account of events. You
              then answer "no comment" to questions.
            </p>
            <p>Benefits of a prepared statement:</p>
            <ul>
              <li>
                Puts key facts on record (which can matter for s.34 if you later rely on those
                facts)
                <Ref n={1} />
              </li>
            ...
            <p>
              Having represented hundreds of clients at Kent police stations, I can tell you that
              "no comment" is a legitimate and often sensible approach – but it should never be a
              default position without proper consideration.
            </p>
            <p>
              I always conduct a thorough consultation before interview, reviewing the disclosure,
              understanding your instructions, and advising on the best approach for your specific
              situation. Sometimes that's "no comment," sometimes a prepared statement, and
              sometimes a full account.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  "No comment" is a response used during police interviews to exercise your right to
                  silence. It means you are choosing not to answer a question. You cannot be
                  punished for saying "no comment," but the court may draw adverse inferences in
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  No, you cannot be convicted simply for staying silent. However, if you later rely
                  on a defence in court that you could have mentioned during interview, the court
                  may draw an "adverse inference" – meaning they may view your silence as
                  suspicious.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  You should consider "no comment" when: the police haven't disclosed enough about
                  the allegations, you need time to gather evidence, the questions are confusing or
                  misleading, or your solicitor advises it. Always get legal advice first.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  An adverse inference is when a court treats your silence during police interview
                  as potentially supporting the prosecution case. If you fail to mention something
                  you later rely on in court, the jury may conclude you made it up afterwards.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  A prepared statement can be an effective middle ground. It allows you to put your
                  account on record (protecting against adverse inferences) while avoiding the risks
                  of a full police interview. Your solicitor can help you prepare this.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 text-white rounded-xl p-8 my-12">
            ...
            <p className="text-slate-300 mb-6">
              Don't decide on your interview strategy without professional advice. I provide free,
              independent legal representation at police stations across Kent, including advice on
              whether to go "no comment."
            </p>
