...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${station.name} Police Station Information | Independent Criminal Defence Solicitors`,
    description: `${SEO_NOT_POLICE} Independent guide to ${station.name} police station (${custodyDescription}, ${station.areaCovered}). Legal representation for Kent custody and booked interviews — not a police contact number.`,
    alternates: {
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">{station.name} Police Station Information</h1>
              <p className="text-lg text-blue-100 mb-4">
                Independent solicitor information — not an official Kent Police page.
              </p>
