      ...
      <main className="flex-grow relative" id="main-content" role="main" aria-live="polite">
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <p className="text-lg text-slate-700 mb-8">
            This is general information for England &amp; Wales. The right approach depends on the
            allegation and the evidence.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-10 rounded-r-lg">
            <p className="text-slate-900">
              <strong>Quick Answer:</strong> Ask for legal advice (PACE s.58).
              <Ref n={1} /> Interview rules are in PACE Code C and interviews are recorded under
              Codes E/F.
              <Ref n={2} /> <Ref n={3} /> <Ref n={4} /> Silence can have legal implications in some
              circumstances (CJPOA s.34).
              <Ref n={5} />
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul>
              <li>
                <strong>Ask for a solicitor</strong> and take advice before you answer questions
                (PACE s.58).
                <Ref n={1} />
              </li>
              <li>
                <strong>Read the caution carefully</strong> and ask for clarification if you don’t
                understand it (Code C).
                <Ref n={2} />
              </li>
              <li>
                <strong>Take breaks</strong> if you are tired, unwell, or not understanding what is
                being asked (Code C).
                <Ref n={2} />
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                Don’t assume “no comment” is always risk-free (CJPOA s.34 can apply in some cases).
                <Ref n={5} />
              </li>
            </ul>
