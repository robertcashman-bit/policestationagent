...
export const metadata: Metadata = {
  ...
  description:
    "Read real testimonials from clients we've helped across Kent. Trusted police station representation and criminal defence services.",
  alternates: {
    canonical: "https://www.policestationagent.com/testimonials",
  },
  openGraph: {
    title: "Client Testimonials",
    description: "Read real testimonials from clients we've helped across Kent.",
    type: "website",
    url: "https://www.policestationagent.com/testimonials",
  },
};
              ...
              <div className="inline-flex items-center justify-center gap-1 mb-4">
                {[...Array(5)].map((_, i) => (
                  <svg
                    ...
                    className="lucide lucide-star w-6 h-6 text-amber-400 fill-current"
                  >
        ...
        <section className="py-16 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Trusted by clients who needed clear advice at the police station
            </p>
