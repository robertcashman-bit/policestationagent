...
export const metadata: Metadata = {
  title: "Police Station Agent Cover for Solicitors | Within 45 mins of Maidstone",
  description:
    "Police station agent cover for criminal defence firms — attendance within about 45 minutes of Maidstone. Freelance solicitor attendance, attendance notes, custody and voluntary interviews. NOT the police.",
  alternates: {
  ...
  openGraph: {
    title: "Police Station Agent Cover for Solicitors | Within 45 mins of Maidstone",
    description:
      "Police station agent cover for criminal solicitor firms — police station attendance within about 45 minutes of Maidstone. Attendance notes, Legal Aid and private client work.",
    type: "website",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 text-slate-800 flex flex-col">
      <ComprehensiveLegalServiceSchema
        ...
        serviceDescription="Police station rep for solicitors is a professional agency service providing expert police station representation for criminal solicitor firms. Qualified solicitor attendance and detailed attendance notes at police stations within about 45 minutes of Maidstone."
        serviceType="Police Station Representation"
        areaServed="Police stations within about 45 minutes of Maidstone"
          ...
          >
            <div className="text-center mb-8">
              <h2 id="firm-enquiry-heading" className="text-3xl font-black text-slate-900">
                Instruct police station agent cover
              </h2>
