...
export const metadata: Metadata = {
  ...
  description:
    "Police station cover for criminal defence firms in Kent. Freelance agent attendance, attendance notes, custody and voluntary interviews. NOT the police.",
  alternates: {
    canonical: "https://policestationagent.com/for-solicitors",
  },
  openGraph: {
    title: "Police Station Rep for Solicitors | Agent Cover Services Kent",
    description:
      "Professional police station rep services for criminal solicitor firms in Kent. Expert agent cover with detailed attendance notes. Legal Aid and private client work available.",
    type: "website",
