...
export default function DNAFingerprintsPolicePage() {
  const sources: LegalSource[] = [
    ...
    },
    {
      id: "pace-s65",
      label:
        "PACE s.65 (definitions incl. “appropriate consent”, “intimate sample”, “non-intimate sample”)",
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded-r-lg">
            <p className="text-lg font-medium text-slate-800">
              ...
              samples (including non‑intimate samples under s.63 and intimate samples under s.62).
              <Ref n={1} /> <Ref n={2} /> <Ref n={3} /> Key terms (including “appropriate consent”,
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              There are different categories of samples in law, with different rules for each
              (fingerprints, non‑intimate samples, and intimate samples).
              <Ref n={1} /> <Ref n={2} /> <Ref n={3} /> <Ref n={4} />
            </p>

            <h3>Fingerprints</h3>
            <p>
              PACE section 61 governs fingerprinting and includes cases where fingerprints may be
              taken without “appropriate consent” (with consent rules also addressed in the
              section).
              <Ref n={1} />
            </p>
            ...
            <ul>
              <li>
                <strong>DNA mouth swab</strong> – rubbed inside cheek
              </li>
              <li>
                <strong>Hair samples (excluding pubic hair)</strong> – including roots
              </li>
              <li>
                <strong>Swabs from external body surfaces</strong> – not body orifices
              </li>
              <li>
                <strong>Footprints</strong> – less common but possible
              </li>
            </ul>
            <p>
              PACE section 63 governs non‑intimate samples and includes circumstances where they may
              be taken without “appropriate consent”.
              <Ref n={2} /> Terms (including “non‑intimate sample” and “appropriate consent”) are
              addressed in section 65.
              <Ref n={4} />
            </p>
            ...
            <ul>
              ...
              <li>
                <strong>Swabs from body orifices</strong> (except mouth)
              </li>
              <li>
                <strong>Dental impressions</strong>
              </li>
            </ul>
            <p>
              PACE section 62 provides that an intimate sample may be taken from a person in police
              detention only if authorisation and “appropriate consent” requirements are met
              (subject to the section).
              <Ref n={3} /> Definitions are in section 65.
              <Ref n={4} />
            </p>
            ...
            <ul>
              <li>
                <strong>Different rules apply</strong> depending on whether it is fingerprints, an
                intimate sample, or a non‑intimate sample.
                <Ref n={1} /> <Ref n={2} /> <Ref n={3} /> <Ref n={4} />
              </li>
              <li>
                <strong>Intimate samples</strong> have additional statutory safeguards (including
                consent/authorisation requirements).
                <Ref n={3} />
              </li>
            </ul>
          </div>
          ...
          <div className="my-12">
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  PACE section 63 sets out rules on non‑intimate samples and when they may be taken
                  with or without “appropriate consent”.
                  <Ref n={2} /> <Ref n={4} />
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  PACE section 61 sets out when fingerprints may be taken without “appropriate
                  consent”.
                  <Ref n={1} />
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  Retention/deletion depends on the legal basis and your circumstances. Take advice
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  Whether deletion is possible depends on the legal basis for retention and your
                  circumstances. Take advice on your case.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  PACE defines “intimate sample” and section 62 sets out key safeguards (including
                  consent/authorisation requirements).
                  <Ref n={3} /> <Ref n={4} />
                </p>
              </div>
