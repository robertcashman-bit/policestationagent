...
export const metadata: Metadata = {
  title: "Police Station Rep Tonbridge | FREE 24/7 | Accredited Duty Solicitor",
  description: "Expert police station rep in Tonbridge, Kent. FREE 24/7 representation at Tonbridge custody suite. Serving West Kent. Call 01732 247427.",
  alternates: {
...
const localBusinessSchema = {
  ...
  "description": "Expert police station rep service in Tonbridge, Kent. FREE 24/7 representation at Tonbridge custody suite' for police interviews and custody matters.",
  "address": {
    "@type": "PostalAddress",
          ...
          <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-16">
            <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              <p className="mt-4 text-lg text-blue-200 max-w-3xl mx-auto">
                Expert police station rep service covering Tonbridge custody suite. FREE 24/7 representation by accredited duty solicitor Robert Cashman.
              </p>
            </div>
          </section>
                ...
                <div className="rounded-xl border bg-card text-card-foreground shadow-lg">
                  <div className="p-6">
                    ...
                    <p className="text-slate-700 leading-relaxed mb-4">
                      If you or someone you know has been arrested or invited for a police interview in Tonbridge, you need expert representation. As Kent's leading police station rep service, we provide FREE legal advice 24/7 at Tonbridge custody suite'.
                    </p>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      Our accredited duty solicitor Robert Cashman has 35+ years of experience and has handled 6000+ cases. Unlike call-centre services, you get direct access to a qualified solicitor who understands Tonbridge's police procedures.
                    </p>
