...
export default function MaidstonePoliceStationRepsPage() {
  return (
    <>
      <section className="bg-[var(--navy)] py-10 sm:py-14">
        <div className="page-container !py-0">
          <Breadcrumbs
            ...
            items={[
              { label: 'Home', href: '/' },
              { label: 'MaidstonePoliceStationReps' },
            ]}
          />
          <h1 className="mt-3 text-h1 text-white">MaidstonePoliceStationReps | PoliceStationRepUK</h1>
