...
export default function Page() {
  ...
  const rightsFaq = [
    {
      question: "What is the most important right in police custody?",
      answer:
        "Your right to free, independent legal advice under PACE s.58. Always ask to speak to a solicitor before answering questions about the alleged offence.",
    },
    {
      question: "Can I have someone told I have been arrested?",
      answer:
        "Yes. Under PACE s.56 you can have one person informed of your arrest. For under-18s, a parent or guardian must be informed.",
    },
    {
      question: "Do I have to answer police questions in custody?",
      answer:
        "No. You have a right to silence. A solicitor will advise whether to answer questions, make a prepared statement, or remain silent.",
    },
    {
      question: "Can I see the PACE Codes of Practice?",
      answer:
        "Yes. You can ask to see PACE Code C, which governs detention, treatment and questioning. Your solicitor can also check custody record entries.",
    },
  ];

  return (
    <>
      <FAQPage items={rightsFaq} />
