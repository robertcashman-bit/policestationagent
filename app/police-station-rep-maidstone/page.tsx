...
export const metadata: Metadata = {
  ...
  description: "Police station rep for Maidstone voluntary interviews. FREE legal advice extended hours. Accredited duty solicitor covering Maidstone and mid-Kent. Call 01732 247427.",
  alternates: {
    canonical: `https://${SITE_DOMAIN}/police-station-rep-maidstone`,
  },
  openGraph: {
    title: "Police Station Rep Maidstone | FREE extended hours | Accredited Duty Solicitor",
    description: "Police station rep for Maidstone voluntary interviews. FREE legal advice extended hours. Accredited duty solicitor covering Maidstone and mid-Kent.",
...
const localBusinessSchema = {
  ...
  "description": "Expert police station rep service in Maidstone, Kent. FREE extended hours representation for voluntary interviews' for police interviews and custody matters.",
  "address": {
    "@type": "PostalAddress",
        ...
        <div className="bg-slate-50 min-h-screen">
          <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-16">
            <div className="max-w-4xl mx-auto px-4 text-center">
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Police Station Representative in Maidstone, Kent</h1>
              <p className="mt-4 text-lg text-blue-200 max-w-3xl mx-auto">
                Expert police station rep service covering Maidstone voluntary interviews. FREE extended hours representation by accredited duty solicitor Robert Cashman.
              </p>
            </div>
          </section>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                <div className="rounded-xl border bg-card text-card-foreground shadow-lg">
                  <div className="p-6">
                    <h2 className="text-2xl font-bold text-slate-900 mb-4">Police Station Rep Coverage in Maidstone</h2>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      If you or someone you know has been arrested or invited for a police interview in Maidstone, you need expert representation. As Kent's leading police station rep service, we provide FREE legal advice extended hours for voluntary interviews'.
                    </p>
                    <p className="text-slate-700 leading-relaxed mb-4">
                ...
                <div className="rounded-xl border bg-card text-card-foreground shadow-lg">
                  <div className="p-6">
                    <h2 className="text-2xl font-bold text-slate-900 mb-4">Maidstone Police Station Coverage</h2>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      Maidstone police station is located at Palace Avenue, Maidstone, Kent ME15 6NF. We provide expert <a href="/maidstone-police-station" className="text-blue-600 hover:underline font-semibold">police station rep at Maidstone</a> for all arrests and voluntary interviews in the Maidstone area.
                    </p>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      We cover voluntary interviews at Maidstone police stations. Whether you're in Maidstone or Mid-Kent, we can provide immediate representation.
                    </p>
                  </div>
                </div>
              ...
              <aside className="space-y-6">
                <div className="rounded-xl border bg-red-600 text-white shadow-lg p-6 text-center">
                  <h3 className="text-xl font-bold mb-4">Need a Police Station Rep in Maidstone?</h3>
                ...
                <div className="rounded-xl border bg-card text-card-foreground shadow-md">
                  <div className="p-6">
                    ...
                    <p className="text-slate-600 text-sm mb-2">Palace Avenue, Maidstone, Kent ME15 6NF</p>
                    <a href="/maidstone-police-station" className="text-blue-600 hover:underline text-sm font-medium">
