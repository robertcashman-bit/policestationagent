          ...
          <section className="py-16">
            <div className="max-w-6xl mx-auto px-4">
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                <div className="bg-white rounded-xl shadow-lg p-8 border border-slate-200">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-4">
                    We provide expert legal representation at police stations across Kent, available
                    during extended hours. Whether you've been arrested or invited for a voluntary
                    interview, we're here to protect your rights and provide expert legal advice.
                  </p>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 border border-slate-200">
                  <div className="w-12 h-12 rounded-2xl flex items-center justify-center bg-green-100 mb-4">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-users w-6 h-6 text-green-600"
                    >
                  ...
                  <p className="text-slate-600 leading-relaxed mb-4">
                    If the police ask you to attend a voluntary interview, you have the right to
                    legal representation. We provide expert advice and representation for voluntary
                    interviews, helping you understand your rights and the potential consequences.
                  </p>
                  <ul className="space-y-2 text-slate-600">
                    <li className="flex items-start gap-2">
                      <svg
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 border border-slate-200">
                  <div className="w-12 h-12 rounded-2xl flex items-center justify-center bg-purple-100 mb-4">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-briefcase w-6 h-6 text-purple-600"
                    >
                  ...
                  <p className="text-slate-600 leading-relaxed mb-4">
                    ...
                    offers, where possible, representation by Robert Cashman and an enhanced private service. If Robert cannot attend, Tuckers Solicitors LLP will arrange an alternative suitably qualified representative.
                  </p>
                  <ul className="space-y-2 text-slate-600">
                    <li className="flex items-start gap-2">
                      <svg
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>Private representation — Where possible, you may be represented by Robert Cashman, subject to availability and conflicts. If Robert cannot attend, Tuckers Solicitors LLP will arrange an alternative suitably qualified representative.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg
                        className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0"
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 border border-slate-200 mb-16">
                ...
                <a
                  href="/for-solicitors"
                  className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 shadow h-10 rounded-md px-6 bg-amber-600 hover:bg-amber-700 text-white font-bold"
                >
              ...
              <div className="text-center">
                ...
                <p className="text-xl text-slate-600 mb-8">
                  We're available during extended hours to provide expert legal representation
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a
                    href="/contact"
                    className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border bg-white shadow-sm h-12 rounded-md px-8 border-slate-300 text-slate-900 hover:bg-slate-50"
                  >
                    Contact Us
                  </a>
                </div>
                <p className="text-sm text-slate-600 mt-6">
                  <strong>Ask for Robert Cashman, Tuckers Duty Solicitor</strong> — The DSCC have
                  our details
                </p>
              </div>
            </div>
