          ...
          <div className="max-w-6xl mx-auto px-4 py-12">
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="rounded-xl border bg-card text-card-foreground shadow-lg">
                  <div className="p-6">
                    <h2 className="text-2xl font-bold text-slate-900 mb-4">Dover Police Station Coverage</h2>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      Dover police station is located at Park Place, Dover. We provide expert <a href="/dover-police-station" className="text-blue-600 hover:underline font-semibold">police station rep at Dover</a> for all arrests and voluntary interviews in the Dover area.
                    </p>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      We cover voluntary interviews at Dover police stations. Whether you're in Dover or East Kent, we can provide immediate representation.
                    </p>
                  </div>
                </div>
              ...
              <aside className="space-y-6">
                ...
                <div className="rounded-xl border bg-card text-card-foreground shadow-md">
                  <div className="p-6">
                    ...
                    <a href="/dover-police-station" className="text-blue-600 hover:underline text-sm font-medium">
