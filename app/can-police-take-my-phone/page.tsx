...
export default function CanPoliceTakeMyPhonePage() {
  const sources: LegalSource[] = [
    ...
    },
    {
      id: "ripa-s49",
      label:
        "Regulation of Investigatory Powers Act 2000 (RIPA) s.49 (notices requiring disclosure)",
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded-r-lg">
            <p className="text-lg font-medium text-slate-800">
              <strong>Quick Answer:</strong> Police may be able to seize your phone as evidence
              depending on the circumstances and the legal power being used (PACE includes a general
              power of seizure in certain search situations).
              <Ref n={1} /> If seized, PACE section 22 allows retention so long as is necessary in
              all the circumstances (subject to limits, including where a photograph/copy is
              sufficient).
              <Ref n={2} /> If you receive a formal section 49 notice under RIPA, failing to comply
              can be an offence under section 53.
              <Ref n={3} /> <Ref n={4} />
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Police powers depend on the context (for example, during searches). PACE includes a
              general power of seizure in certain situations, including where a constable has
              reasonable grounds to believe an item is evidence and it is necessary to seize it to
              prevent it being concealed, lost, altered or destroyed.
              <Ref n={1} />
            </p>
            ...
            <p>
              Do not guess. If police ask you to unlock your phone or disclose a password, get legal
              advice based on the exact power they are using.
            </p>

            <h3>The RIPA Exception</h3>
            <p>
              Under{" "}
              <strong>Section 49 of the Regulation of Investigatory Powers Act 2000 (RIPA)</strong>,
              a notice can require disclosure of protected information in the circumstances set out
              in the Act.
              <Ref n={3} /> Section 53 makes it an offence to knowingly fail to make the disclosure
              required by virtue of the giving of a section 49 notice.
              <Ref n={4} />
            </p>

            <h2>How Long Can Police Keep Your Phone?</h2>
            <p>
              PACE section 22 provides that seized property may be retained so long as is necessary
              in all the circumstances (subject to the provisions in that section).
              <Ref n={2} /> This can include retention for use as evidence at trial, forensic
              examination, or investigation in connection with an offence.
              <Ref n={2} />
            </p>

            <h2>Getting Your Phone Back</h2>
            <p>
              If police retain your phone, you can request its return once it is no longer needed.
              If there is a dispute about return of property in police possession, a court of
              summary jurisdiction may make orders under the Police (Property) Act 1897.
              <Ref n={5} />
            </p>
            ...
            <ul>
              ...
              <li>
                <strong>Get legal advice:</strong> before disclosing passwords or unlocking a
                device.
              </li>
              <li>
                <strong>Ask about RIPA:</strong> is there a formal section 49 notice?
                <Ref n={3} />
              </li>
              <li>
                <strong>Document:</strong> Note when your phone was seized and by whom
              </li>
              <li>
                <strong>Request return:</strong> Once the matter is concluded
              </li>
            </ul>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  Yes, police can seize your phone when you're arrested as part of a search incident
                  to arrest. They can take it to search for evidence related to the offence.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  Generally, you are not obliged to give police your PIN or password. However, under
                  Section 49 RIPA, police with proper authority can require disclosure, and refusal
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-slate-700">
                  Police can keep your phone for as long as necessary for the investigation. This
                  could be weeks or months. If not charged, you may apply for its return.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  If you're arrested, police can seize your phone without a warrant. To examine its
                  contents, they may need authorisation under PACE. Phones are often examined after
                  seizure using forensic tools.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="font-bold text-lg text-blue-900 mb-2">
                ...
                <p className="text-slate-700">
                  If released without charge, you should be able to reclaim your phone. However,
                  police may retain it if the investigation continues. A solicitor can help expedite
                  return.
                </p>
              </div>
            </div>
