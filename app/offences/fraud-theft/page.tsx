          ...
          <div className="max-w-4xl mx-auto px-4 py-16">
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700">
                We provide police station representation and advice for fraud and theft allegations across Kent. We can attend Kent custody suites including Medway, North Kent (Gravesend), Canterbury and other operational suites, plus voluntary interview stations such as Maidstone (custody closed / VAI only).
              </p>
            </section>
