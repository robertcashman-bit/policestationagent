...
export const metadata: Metadata = {
  title: "Fraud Theft | Police Station Representation Kent | Legal Aid",
  description:
    "Expert police station representation for fraud and theft allegations across Kent. Free legal advice under Legal Aid. Early advice before interview is important. Call 01732 247427.",
  alternates: {
    canonical: "https://policestationagent.com/offences/fraud-theft",
  },
};

export default function FraudTheftPage() {
  const breadcrumbItems = [
    { name: "Home", url: baseUrl },
    { name: "Offences We Deal With", url: `${baseUrl}/offences-we-deal-with` },
    { name: "Fraud / Theft", url: `${baseUrl}/offences/fraud-theft` },
  ];
      ...
      <main className="flex-grow relative" id="main-content" role="main" aria-live="polite">
        <div className="bg-slate-50 min-h-screen">
          <div className="max-w-4xl mx-auto px-4 py-16">
            <section
              className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-800 text-white py-16 rounded-xl mb-8"
            ...
            >
              <div className="max-w-3xl mx-auto text-center px-4">
                ...
                <p className="text-xl text-indigo-100 mb-8">
                  If the police want to interview you about a fraud or theft allegation, it is important to obtain legal advice as soon as possible.
                </p>
              </div>
            </section>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-6">
                Understanding Fraud and Theft Allegations
              </h2>
              <p className="text-slate-700 mb-4">
                Fraud and theft allegations can involve:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-indigo-600 font-bold mt-1">•</span>
                  <span><strong>Theft:</strong> Taking property belonging to another person with the intention of permanently depriving them of it.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-indigo-600 font-bold mt-1">•</span>
                  <span><strong>Fraud:</strong> Dishonestly making a false representation, failing to disclose information, or abusing a position of trust for gain or to cause loss.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-indigo-600 font-bold mt-1">•</span>
                  <span><strong>Burglary:</strong> Entering a building as a trespasser with the intention of stealing, causing damage, or committing other offences.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-indigo-600 font-bold mt-1">•</span>
                  <span><strong>Handling Stolen Goods:</strong> Receiving, retaining, or disposing of stolen goods.</span>
                </li>
              </ul>
              <p className="text-slate-700 mb-4">
              ...
              <p className="text-slate-700">
                We provide police station representation and advice for fraud and theft allegations across Kent. We can attend police stations including Medway, Maidstone, Canterbury, Gravesend, and other custody suites across the county.
              </p>
            </section>

            <section className="bg-indigo-50 rounded-xl border-2 border-indigo-200 shadow-lg p-6 md:p-8 mb-8">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-6">
                If the Police Want to Interview You
              </h2>
              <p className="text-slate-700 mb-4">
                If the police want to interview you about a fraud or theft allegation:
              </p>
              ...
              <p className="text-slate-700">
                We can attend police stations across Kent to provide advice and representation. Legal Aid is usually available at the police station for fraud and theft interviews.
              </p>
            </section>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                You may be asked to attend a voluntary interview or you may be arrested for a fraud or theft allegation.
              </p>
            ...
            <section className="bg-blue-50 rounded-xl border-2 border-blue-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                After interview for a fraud or theft allegation, you may be:
              </p>
              <ul className="space-y-3 text-slate-700 mb-6">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                  <span><strong>Released Under Investigation (RUI):</strong> The investigation continues. You may be contacted again. There are usually no conditions, but the police may continue to gather evidence.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                If the police want to interview you about a fraud or theft allegation, we can:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
            ...
            <section className="bg-slate-50 rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                Early legal advice is important for fraud and theft allegations because:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                  <span><strong>Understanding the Allegations:</strong> We can help you understand what you are being accused of, the value involved, and what evidence the police may have.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                  <span><strong>Complexity:</strong> Fraud and theft cases can be complex. Early advice can help you understand the allegations and your position.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                If arrested for a fraud or theft allegation, you have rights in custody, including:
              </p>
            ...
            <section className="bg-blue-50 rounded-xl border-2 border-blue-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Is legal advice free for fraud and theft allegations?</h3>
                  <p className="text-slate-700">Yes. Legal Aid is usually available at the police station for fraud and theft interviews, whether voluntary or under arrest.</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What is the difference between fraud and theft?</h3>
                  <p className="text-slate-700">Theft involves taking property. Fraud involves dishonestly making false representations or abusing a position of trust.</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What if I am arrested for fraud or theft?</h3>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Can I have a solicitor at a voluntary interview for fraud or theft?</h3>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What if I did not intend to commit fraud or theft?</h3>
                  <p className="text-slate-700">Intent is an important element. We can advise on intent and help you present your case.</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What are bail conditions in fraud and theft cases?</h3>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">How long can a fraud or theft investigation take?</h3>
            ...
            <section className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-800 text-white rounded-xl shadow-lg p-6 md:p-8 mb-8">
              <h2 className="text-2xl md:text-3xl font-black text-white mb-6">
                What Happens Next
              </h2>
              <p className="text-indigo-100 mb-6">
                If the police want to interview you about a fraud or theft allegation, it is important to obtain legal advice as soon as possible. We can:
              </p>
              <ul className="space-y-3 text-indigo-100 mb-6">
                <li className="flex items-start gap-3">
