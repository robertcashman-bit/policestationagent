...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.policestationagent.com/offences/assault-abh-gbh",
  },
};

export default function AssaultABHGBHPage() {
  const breadcrumbItems = [
    { name: "Home", url: baseUrl },
    { name: "Offences We Deal With", url: `${baseUrl}/offences-we-deal-with` },
    { name: "Assault / ABH / GBH", url: `${baseUrl}/offences/assault-abh-gbh` },
  ];
          ...
          <div className="max-w-4xl mx-auto px-4 py-16">
            ...
            >
              <div className="max-w-3xl mx-auto text-center px-4">
                ...
                <p className="text-xl text-amber-100 mb-8">
                  If the police want to interview you about an assault, actual bodily harm (ABH), or grievous bodily harm (GBH) allegation, it is important to obtain legal advice as soon as possible.
                </p>
              </div>
            </section>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-6">
                Understanding Assault, ABH, and GBH
              </h2>
              <p className="text-slate-700 mb-4">
                Assault allegations can involve:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-amber-600 font-bold mt-1">•</span>
                  <span><strong>Common Assault:</strong> The least serious form of assault, which can include threatening behaviour or minor physical contact.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-amber-600 font-bold mt-1">•</span>
                  <span><strong>Actual Bodily Harm (ABH):</strong> Assault that causes actual bodily harm, which means any hurt or injury that interferes with health or comfort.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-amber-600 font-bold mt-1">•</span>
                  <span><strong>Grievous Bodily Harm (GBH):</strong> Serious harm, which can include really serious bodily harm (GBH with intent) or wounding with intent.</span>
                </li>
              </ul>
              <p className="text-slate-700 mb-4">
              ...
              <p className="text-slate-700">
                We provide police station representation and advice for assault, ABH, and GBH allegations across Kent. We can attend Kent custody suites including Medway, North Kent (Gravesend), Canterbury and other operational suites, plus voluntary interview stations such as Maidstone (custody closed / VAI only).
              </p>
            </section>
            ...
            <section className="bg-amber-50 rounded-xl border-2 border-amber-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                If the police want to interview you about an assault, ABH, or GBH allegation:
              </p>
              ...
              <p className="text-slate-700">
                We can attend police stations across Kent to provide advice and representation. Legal Aid is usually available at the police station for assault interviews.
              </p>
            </section>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                You may be asked to attend a voluntary interview or you may be arrested for an assault allegation.
              </p>
            ...
            <section className="bg-blue-50 rounded-xl border-2 border-blue-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                After interview for an assault allegation, you may be:
              </p>
              <ul className="space-y-3 text-slate-700 mb-6">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                  <span><strong>Police Bail:</strong> Conditions may be imposed, such as not contacting the complainant or not going to a specific address. You must return to the police station on a specified date.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                If the police want to interview you about an assault, ABH, or GBH allegation, we can:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
            ...
            <section className="bg-slate-50 rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                Early legal advice is important for assault allegations because:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                  <span><strong>Understanding the Allegations:</strong> We can help you understand what you are being accused of, the level of harm alleged, and what evidence the police may have.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                  <span><strong>Self-Defence:</strong> We can advise on self-defence and other potential defences.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                If arrested for an assault allegation, you have rights in custody, including:
              </p>
            ...
            <section className="bg-blue-50 rounded-xl border-2 border-blue-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Is legal advice free for assault allegations?</h3>
                  <p className="text-slate-700">Yes. Legal Aid is usually available at the police station for assault interviews, whether voluntary or under arrest.</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What is the difference between assault, ABH, and GBH?</h3>
                  <p className="text-slate-700">Common assault is the least serious. ABH involves actual bodily harm. GBH involves serious harm and can carry more serious penalties.</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What if I am arrested for assault?</h3>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Can I have a solicitor at a voluntary interview for assault?</h3>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What if I acted in self-defence?</h3>
                  <p className="text-slate-700">Self-defence can be a defence to assault allegations. We can advise on self-defence and help you present your case.</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What are bail conditions in assault cases?</h3>
                  <p className="text-slate-700">Bail conditions may include not contacting the complainant or not going to a specific address. Conditions can vary depending on the allegation.</p>
                </div>
                <div>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">How long can an assault investigation take?</h3>
            ...
            <section className="bg-gradient-to-br from-amber-600 via-amber-700 to-amber-800 text-white rounded-xl shadow-lg p-6 md:p-8 mb-8">
              <h2 className="text-2xl md:text-3xl font-black text-white mb-6">
                What Happens Next
              </h2>
              <p className="text-amber-100 mb-6">
                If the police want to interview you about an assault, ABH, or GBH allegation, it is important to obtain legal advice as soon as possible. We can:
              </p>
