          ...
          <div className="max-w-4xl mx-auto px-4 py-16">
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700">
                We provide police station representation and advice for assault, ABH, and GBH allegations across Kent. We can attend police stations including Medway, Maidstone, Canterbury, Gravesend, and other custody suites across the county.
              </p>
            </section>
