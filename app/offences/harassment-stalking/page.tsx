...
export default function HarassmentStalkingPage() {
  const breadcrumbItems = [
    { name: "Home", url: baseUrl },
    { name: "Offences We Deal With", url: `${baseUrl}/offences-we-deal-with` },
    { name: "Harassment / Stalking", url: `${baseUrl}/offences/harassment-stalking` },
  ];
      ...
      <main className="flex-grow relative" id="main-content" role="main" aria-live="polite">
        <div className="bg-slate-50 min-h-screen">
          <div className="max-w-4xl mx-auto px-4 py-16">
            <section
              className="bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800 text-white py-16 rounded-xl mb-8"
            ...
            >
              <div className="max-w-3xl mx-auto text-center px-4">
                ...
                <p className="text-xl text-purple-100 mb-8">
                  If the police want to interview you about a harassment or stalking allegation, it is important to obtain legal advice as soon as possible.
                </p>
              </div>
            </section>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-6">
                Understanding Harassment and Stalking Allegations
              </h2>
              <p className="text-slate-700 mb-4">
                Harassment and stalking allegations can involve:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 font-bold mt-1">•</span>
                  <span><strong>Harassment:</strong> Conduct that causes alarm or distress, which can include repeated unwanted contact, threats, or other behaviour.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 font-bold mt-1">•</span>
                  <span><strong>Stalking:</strong> A course of conduct that causes fear, alarm, or distress, which can include following, monitoring, or other persistent behaviour.</span>
                </li>
              </ul>
              <p className="text-slate-700 mb-4">
              ...
              <p className="text-slate-700">
                We provide police station representation and advice for harassment and stalking allegations across Kent. We can attend police stations including Medway, Maidstone, Canterbury, Gravesend, and other custody suites across the county.
              </p>
            </section>

            <section className="bg-purple-50 rounded-xl border-2 border-purple-200 shadow-lg p-6 md:p-8 mb-8">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-6">
                If the Police Want to Interview You
              </h2>
              <p className="text-slate-700 mb-4">
                If the police want to interview you about a harassment or stalking allegation:
              </p>
              ...
              <p className="text-slate-700">
                We can attend police stations across Kent to provide advice and representation. Legal Aid is usually available at the police station for harassment interviews.
              </p>
            </section>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                You may be asked to attend a voluntary interview or you may be arrested for a harassment or stalking allegation.
              </p>
            ...
            <section className="bg-blue-50 rounded-xl border-2 border-blue-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                After interview for a harassment or stalking allegation, you may be:
              </p>
              <ul className="space-y-3 text-slate-700 mb-6">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                  <span><strong>Released Under Investigation (RUI):</strong> The investigation continues. You may be contacted again. There are usually no conditions, but the police may apply for a restraining order.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
              ...
              <p className="text-slate-700">
                Bail conditions in harassment and stalking cases can be restrictive. We can advise on bail conditions and your obligations. For more information, see our page on <Link href="/police-bail-explained" className="text-blue-600 hover:underline">police bail explained</Link>.
              </p>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                If the police want to interview you about a harassment or stalking allegation, we can:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
            ...
            <section className="bg-slate-50 rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                Early legal advice is important for harassment and stalking allegations because:
              </p>
              <ul className="space-y-3 text-slate-700 mb-4">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
                  <span><strong>Restraining Orders:</strong> We can advise on restraining orders and non-molestation orders that may be applied for.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold mt-1">•</span>
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <p className="text-slate-700 mb-4">
                If arrested for a harassment or stalking allegation, you have rights in custody, including:
              </p>
            ...
            <section className="bg-blue-50 rounded-xl border-2 border-blue-200 shadow-lg p-6 md:p-8 mb-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Is legal advice free for harassment allegations?</h3>
                  <p className="text-slate-700">Yes. Legal Aid is usually available at the police station for harassment interviews, whether voluntary or under arrest.</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What is the difference between harassment and stalking?</h3>
                  <p className="text-slate-700">Harassment involves conduct that causes alarm or distress. Stalking involves a course of conduct that causes fear, alarm, or distress.</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What if I am arrested for harassment?</h3>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Can I have a solicitor at a voluntary interview for harassment?</h3>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What are bail conditions in harassment cases?</h3>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">What is a restraining order?</h3>
                  <p className="text-slate-700">A restraining order is a court order that can prohibit you from contacting or approaching certain people or going to specific places.</p>
                </div>
                <div>
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">How long can a harassment investigation take?</h3>
            ...
            <section className="bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800 text-white rounded-xl shadow-lg p-6 md:p-8 mb-8">
              <h2 className="text-2xl md:text-3xl font-black text-white mb-6">
                What Happens Next
              </h2>
              <p className="text-purple-100 mb-6">
                If the police want to interview you about a harassment or stalking allegation, it is important to obtain legal advice as soon as possible. We can:
              </p>
              <ul className="space-y-3 text-purple-100 mb-6">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-amber-300 font-bold mt-1">•</span>
                  <span>Guide you on bail conditions, RUI, restraining orders, and next steps</span>
                </li>
              </ul>
              <p className="text-purple-100 mb-6">
