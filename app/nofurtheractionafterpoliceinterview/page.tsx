  ...
  const sources: LegalSource[] = [
    {
      id: "cps-code",
      label:
        "CPS: The Code for Crown Prosecutors (Full Code Test: evidential stage + public interest stage)",
      ...
      <main className="flex-grow relative" id="main-content" role="main" aria-live="polite">
        <article className="max-w-4xl mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">
            “No Further Action” (NFA): what it generally means
          </h1>
          <p className="text-lg text-slate-700 mb-8">
            “No Further Action” is commonly used to mean that, at that point, no charge/prosecution
            will follow from the investigation you were interviewed about.
          </p>

          <div className="bg-green-50 border-l-4 border-green-600 p-6 mb-10 rounded-r-lg">
            <p className="text-slate-900">
              <strong>Quick Answer:</strong> If your case is referred to the Crown Prosecution
              Service, the CPS applies the “Full Code Test” (evidential stage + public interest
              stage).
              <Ref n={1} />
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul>
              ...
              <li>
                If you have an ongoing investigation status (bail/RUI), take advice on what that
