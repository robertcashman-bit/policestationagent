...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: "/directory/thames-valley-police", destination: "/find-station?q=Thames%20Valley%20Police", permanent: true },
      { source: "/directory/british-transport-police", destination: "/find-station?q=British%20Transport%20Police", permanent: true },
      { source: "/directory/suffolk-constabulary", destination: "/find-station?q=Suffolk%20Constabulary", permanent: true },
      { source: "/directory/metropolitan-police", destination: "/find-station?q=Metropolitan%20Police", permanent: true },
      { source: "/directory/south-wales-police", destination: "/find-station?q=South%20Wales%20Police", permanent: true },
      { source: "/directory/lancashire-constabulary", destination: "/find-station?q=Lancashire%20Constabulary", permanent: true },
