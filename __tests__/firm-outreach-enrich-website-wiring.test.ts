 ...
 * move the prospect to ready_to_send. Previously the discovery step did not exist
 * in this repo, so any prospect without an SRA-listed website produced no email.
 */
