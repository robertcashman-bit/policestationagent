...
const testimonials: Testimonial[] = [
  ...
  {
    quote: "Professional, calm and extremely knowledgeable. Robert explained everything clearly and was there throughout the entire process.",
    author: "JB",
    location: "Maidstone",
    rating: 5,
  },
  {
    quote: "I was terrified when the police contacted me. Robert attended quickly and handled everything professionally. Case dropped.",
    author: "TC",
    location: "Canterbury",
    rating: 5,
  },
  {
    quote: "Excellent duty solicitor. Arrived within 30 minutes and gave me confidence during a very stressful time.",
    author: "DM",
    location: "Medway",
    rating: 5,
  },
  {
    quote: "Robert's experience showed from the start. He knew exactly what questions to challenge and protected my rights throughout.",
    author: "SS",
    location: "Gravesend",
    rating: 5,
  },
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Trusted by Clients Across Kent</h2>
          <p className="text-lg text-blue-200 max-w-2xl mx-auto">Real experiences from clients we've helped through challenging times</p>
        </div>
