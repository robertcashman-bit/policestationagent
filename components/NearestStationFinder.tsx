...
export default function NearestStationFinder() {
  const stations: Station[] = useMemo(
    () => [
      ...
      { name: "Canterbury", slug: "canterbury", lat: 51.28, lng: 1.079 },
      { name: "Gravesend (North Kent)", slug: "north-kent", lat: 51.441, lng: 0.37 },
  ...
  return (
    ...
    >
      ...
      <p className="text-slate-700 mb-4">
        ...
        page with contact and coverage details.
      </p>
      ...
      {nearest && (
        <div className="mt-5 rounded-lg bg-white border border-slate-200 p-4">
          ...
          <div className="mt-3">
            <Link
              href={`/police-stations/${nearest.station.slug}`}
