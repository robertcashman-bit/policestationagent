...
export function AuthorBio({ className = "", showFull = true }: AuthorBioProps) {
  const shortVersion = (
    <p className="text-slate-700">
      <strong>Robert Cashman</strong> is a qualified solicitor and accredited duty solicitor with 30+ years experience in police station representation. Legal services are provided by Tuckers Solicitors LLP (SRA ID: 127795).
    </p>
  );
  ...
  const fullVersion = (
    <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
      ...
      <p className="text-slate-700 mb-3">
        <strong>Robert Cashman</strong> is a qualified solicitor and accredited duty solicitor with 30+ years experience in police station representation. He has handled over 21,000 cases and is a Higher Court Advocate qualified to practice in the Crown Court.
      </p>
      <p className="text-slate-700 mb-3">
