  ...
  return (
    <div className="bg-blue-50 border-l-4 border-blue-600 p-6 my-8 rounded-r-lg">
      ...
      <p className="text-slate-700 mb-4">
        <strong>
          I am a qualified Police Station Duty Solicitor, not an agency or unregulated
          representative.
        </strong>{" "}
        With Higher Rights of Audience (Criminal) and over 35 years of experience, I provide expert
        representation across all Kent custody suites.
      </p>

      <p className="text-slate-700 mb-4">
        As an Accredited Duty Solicitor, I ensure your rights are protected under PACE 1984. My
        service covers Medway, Maidstone, Canterbury, Gravesend, and all Kent police stations.
      </p>
