export function SolicitorInstructionChecklist() {
  ...
  return (
    <section
      className="surface-card border-accent/30 bg-secondary/60 p-6"
      aria-labelledby="instruction-checklist"
    >
      <h2 id="instruction-checklist" className="text-lg font-bold text-primary mb-3">
